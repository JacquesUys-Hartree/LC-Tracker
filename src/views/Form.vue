<template>
  <div>
    <h1>Form ID: {{ id }}</h1>
    <v-form ref="lcForm" v-model="formValidity">
      <v-container>
        <v-row>
          <v-col cols="12">
        ...
        <v-row>
          <v-col cols="12" md="6">
            <v-subheader>Is the advising bank confirming?</v-subheader>
    ...
    submitForm() {
      this.postForm("forms")
        .then(() => {
          ...
          this.snackBarText = "Form has been submitted."
        })
        .catch(() => {
          console.log("error")
          this.snackbar = true;
          this.snackColor = "red";
          this.snackBarText = "Form did not submit."
        });
    },
    saveForm() {
      this.postForm("drafts")
        .then(() => {
          ...
          this.snackBarText = "Form has been saved."
        })
        .catch(() => {
          this.snackbar = true;
          this.snackColor = "red";
          this.snackBarText = "Form did not save."
        })
    },
    init() {
